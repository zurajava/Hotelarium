...
export class editOwnerComponent implements OnInit,OnDestroy {
  ...
  constructor(public toastr: ToastsManager,vcr: ViewContainerRef,private route:ActivatedRoute,private viewownerservice:BranchService, private fb: FormBuilder,private editownerservice:EditBranchService) 
  {
